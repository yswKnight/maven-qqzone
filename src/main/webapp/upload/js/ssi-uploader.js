...
(function (root, factory) {
    ...
    Ssi_upload.prototype.init = function (element) {
        ...
        if (!this.options.preview) {
            ...
            $uploadBox = $('<div id="ssi-previewBox" class="ssi-uploadBox ssi-previewBox ' + (this.options.dropZone ? 'ssi-dropZonePreview ssi-dropZone">' : '">') + '</div>');
...
//----------------------------UPLOADFILES------------------------------------
    ...
    var locale = {
        en: {
            ...
            extError: '$1 不支持的文件类型',//$1=file extension ie(exe files are not supported)
            someErrorsOccurred: '错误一些发生!'
        },
        gr: {
            success: 'Επιτυχία',
